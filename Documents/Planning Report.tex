...
The chosen subject, as combining a running application with guiding
...
\begin{figure}[h]
\includegraphics[width=1.1\textwidth]{\lyxdot \lyxdot /\lyxdot \lyxdot /\lyxdot \lyxdot /Dropbox/Chalmers/Kandidatarbete/tabbellfeatures}\caption{Scheme of what features are needed for different modes}
\end{figure}
...
conducting an interview.\pagebreak{}
...
to the Android API Guide - Fragments (2014), fragments seems like
a good way to decompose the functionality of an app into smaller parts
(fragments) that can be reusable and depending on the screen size
show up in different quantities.
...
Timetable following on the next page.

\begin{sidewaysfigure}
\includegraphics[width=0.9\paperwidth]{\lyxdot \lyxdot /\lyxdot \lyxdot /\lyxdot \lyxdot /Dropbox/Chalmers/Kandidatarbete/timetable}\caption{Preliminary Time Plan for the project}
\end{sidewaysfigure}


\pagebreak{}\bibliographystyle{apalike}
\phantomsection\addcontentsline{toc}{section}{\refname}\bibliography{\string"/home/joakim/Desktop/My Collection\string"}
